# Generated by Django 4.2.5 on 2023-10-09 06:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tables.order', verbose_name='Заказ')),
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(through='tables.OrderItem', to='products.product', verbose_name='Товары'),
        ),
    ]
